  ...
  return (
    <Layout>
      ...
      <Section className="bg-gradient-to-br from-myg-teal-light via-background to-background">
        ...
        />
        <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-6 gap-2 sm:gap-3 max-w-4xl mx-auto">
          {[
            banyuleFestival1, youthCamp1, parliamentForum1, 
            elsedeaqIftar1, soccerTournament1, womensDay,
          ].map((src, i) => (
            <a
              key={i}
